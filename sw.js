const CACHE = 'rallymaker-roadbook-v3-20260905f';
const SHELL = ['./', './index.html', './styles.css', './app.js', './roundabout.js', './editor.js', './note-media.js', './icons.js', './store.js', './manifest.webmanifest', './icon.svg'];
